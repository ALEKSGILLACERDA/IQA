...
nivel_qualidade = classificar_IQA(iqa_dominante)

print(f"Poluente com maior valor de IQA: {poluente_dominante}, Valor IQA = {iqa_dominante:.2f}, Qualidade do ar: {nivel_qualidade}")
